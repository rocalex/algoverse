...
class StoreContract:
    ...
    def on_setup(self):
        return Seq(
            ...
            App.globalPut(self.Vars.distribution_app_id_key, Txn.applications[4]),
    ...
    def on_reset(self):
        ...
        return Seq(
            ...
            Seq(
                App.globalPut(self.Vars.total_sold_amount_key, total_sold_amount - App.localGet(Txn.accounts[1], self.Vars.sold_amount_key)),
                App.localPut(Txn.accounts[1], self.Vars.sold_amount_key, Int(0)),
                App.globalPut(self.Vars.total_bought_amount_key, total_bought_amount - App.localGet(Txn.accounts[1], self.Vars.bought_amount_key)),
                App.localPut(Txn.accounts[1], self.Vars.bought_amount_key, Int(0)),
            ),
